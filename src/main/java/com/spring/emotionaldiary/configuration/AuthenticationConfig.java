...
public class AuthenticationConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .cors().and()
                .authorizeRequests()
                .antMatchers("/api/v1/users/email-validation/check","/api/v1/auth/reissue","/api/v1/auth/validate","/api/v1/users/signup","/api/v1/users/login/**","/api/v1/users/email-validation","/api/v1/users/email","/api/v1/users/find-pwd","/sample").permitAll() //접근 허용하는 url
